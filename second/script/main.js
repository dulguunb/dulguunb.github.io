    	...
    	if (key === 13) { // 13 is enter
				var promptValue = document.getElementById("prompt").value;
					if(promptValue == 'Y' || promptValue == '' || promptValue == 'y'){
						...
						document.getElementsByClassName("consoleoutput")[0].innerHTML = "<p> Initializing init.py </p> <p> </p> HTTP request sent, awaiting response... 200 OK <p> Changing background image </p> <p> Getting schwifty </p>";
					}
